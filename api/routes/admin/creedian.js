...
router.post("/creedians", isAuthenticated, function (req, res) {
  try {
    sql.connect(config, function (err) {
      ...
      reqCount.query(`SELECT COUNT(*) FROM [CREEDIAN].[dbo].[user_creedians] ${query}`, function (err, result) {
        if (err) console.log(err);
        ...
        reqData.query(`SELECT * FROM [CREEDIAN].[dbo].[user_creedians] ${query}`, function (err, result) {
          if (err) console.log(err);
...
router.post("/charge-log", isAuthenticated, function (req, res) {
  try {
    sql.connect(config, function (err) {
      if (err) console.log(err);
...
router.post("/use-log", isAuthenticated, function (req, res) {
  try {
    sql.connect(config, function (err) {
      if (err) console.log(err);
